...
function enableTypeCoercion(type) {
  ...
  if (type instanceof ZodString || type instanceof ZodLiteral || type instanceof ZodEnum || type instanceof ZodNativeEnum) {
    ...
    schema = anyType().transform((value) => {
      ...
      return [value];
    }).pipe(new ZodArray(_objectSpread22(_objectSpread22({}, type._def), {}, {
    ...
    schema = new ZodObject(_objectSpread22(_objectSpread22({}, type._def), {}, {
      shape: () => _shape
    }));
  } else if (type instanceof ZodEffects) {
    if (isFileSchema(type)) {
      ...
      schema = new ZodEffects(_objectSpread22(_objectSpread22({}, type._def), {}, {
        schema: enableTypeCoercion(type.innerType(), cache)
      }));
    }
  } else if (type instanceof ZodOptional) {
    schema = anyType().transform((value) => coerceFile(coerceString(value))).pipe(new ZodOptional(_objectSpread22(_objectSpread22({}, type._def), {}, {
      innerType: enableTypeCoercion(type.unwrap(), cache)
    })));
  } else if (type instanceof ZodDefault) {
    schema = anyType().transform((value) => coerceFile(coerceString(value))).pipe(new ZodDefault(_objectSpread22(_objectSpread22({}, type._def), {}, {
      innerType: enableTypeCoercion(type.removeDefault(), cache)
    })));
  } else if (type instanceof ZodIntersection) {
    schema = new ZodIntersection(_objectSpread22(_objectSpread22({}, type._def), {}, {
    ...
    schema = new ZodUnion(_objectSpread22(_objectSpread22({}, type._def), {}, {
      options: type.options.map((option) => enableTypeCoercion(option, cache))
    }));
  } else if (type instanceof ZodDiscriminatedUnion) {
    schema = new ZodDiscriminatedUnion(_objectSpread22(_objectSpread22({}, type._def), {}, {
      options: type.options.map((option) => enableTypeCoercion(option, cache))
    }));
  } else if (type instanceof ZodTuple) {
    schema = new ZodTuple(_objectSpread22(_objectSpread22({}, type._def), {}, {
      items: type.items.map((item) => enableTypeCoercion(item, cache))
    }));
  } else if (type instanceof ZodNullable) {
    schema = new ZodNullable(_objectSpread22(_objectSpread22({}, type._def), {}, {
      innerType: enableTypeCoercion(type.unwrap(), cache)
    }));
  } else if (type instanceof ZodPipeline) {
    schema = new ZodPipeline(_objectSpread22(_objectSpread22({}, type._def), {}, {
  ...
  (0, import_react.useEffect)(() => {
    var handleInvalid = (event) => {
      ...
      setError((prev) => {
        ...
        return _objectSpread23(_objectSpread23({}, prev), {}, {
...
function useFieldset(ref, config) {
  ...
  return new Proxy({}, {
    get(_target, key) {
      ...
      var field = _objectSpread23(_objectSpread23({}, constraint), {}, {
...
function getFormControlProps(config, options) {
  return cleanup(_objectSpread23(_objectSpread23({}, getFormElementProps(config, options)), {}, {
...
function input(config) {
  var options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
  var props = _objectSpread23(_objectSpread23({}, getFormControlProps(config, options)), {}, {
    type: options.type,
...
function select(config, options) {
  return cleanup(_objectSpread23(_objectSpread23({}, getFormControlProps(config, options)), {}, {
...
function collection(config, options) {
  return options.options.map((value) => cleanup(_objectSpread23(_objectSpread23({}, getFormControlProps(config, options)), {}, {
...
//# sourceMappingURL=/build/_shared/chunk-7WJZA77P.js.map
