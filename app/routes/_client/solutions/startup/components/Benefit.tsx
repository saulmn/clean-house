  ...
  return (
    <section className="bg-white pb-10 pt-20 lg:pt-24">
      <Container>
        ...
        <div className="grid grid-cols-1 gap-y-8 md:grid-cols-4 md:gap-8 lg:grid-cols-6">
          <div className="col-span-1 h-80 w-full rounded-[30px] border-2 border-secondary-200 p-10 md:col-span-2 lg:col-span-2">
          ...
          <div className="col-span-1 h-80 w-full rounded-[30px] border-2 border-secondary-200 p-10 md:col-span-2 lg:col-span-2 lg:hidden">
            <Heading variant="h5" className="pb-6 font-bold">
          ...
          <div className="relative flex h-auto w-full flex-col items-center justify-between overflow-hidden rounded-[30px] p-10 shadow-[0px_24px_184px_-10px_rgba(0,0,0,0.14)] md:col-span-4 md:h-80 md:flex-row lg:col-span-4">
          ...
          <div className="col-span-1 hidden h-80 w-full rounded-[30px] border-2 border-secondary-200 p-10 md:col-span-2 lg:col-span-2 lg:block">
            <Heading variant="h5" className="pb-6 font-bold">
              Send fast, secure payments.
            </Heading>
            <Paragraph variant="body1">
